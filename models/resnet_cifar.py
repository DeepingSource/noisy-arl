'''Credit: https://github.com/MadryLab/robustness/blob/master/robustness/cifar_models/resnet.py
ResNet in PyTorch.
...
'''Credit: https://github.com/MadryLab/robustness/blob/master/robustness/tools/custom_modules.py
'''
ch = torch
